...
namespace Ingenious.Domain.Specifications
{
    /// <summary>
    ...
    public class NotSpecification<T> : Specification<T>
    {
        ...
        {
            var body = Expression.Not(_spec.GetExpression().Body);
            return Expression.Lambda<Func<T, bool>>(body, _spec.GetExpression().Parameters);
        }
        #endregion
    }
}
