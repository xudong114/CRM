...
{
    public sealed class CacheService : ICacheProvider
    {
        ...
        private CacheService()
        {
            ...
            //_cacheProvider = GlobalConfiguration.Configuration.DependencyResolver.GetService(typeof(ICacheProvider)) as ICacheProvider;
